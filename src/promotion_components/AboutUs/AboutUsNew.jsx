...
export default function AboutUsNew() {
  ...
  <div className="relative w-full my-16 flex justify-center">
    {/* Thin golden line */}
    <div className="w-full h-px bg-linear-to-r from-yellow-300/80 via-yellow-400/50 to-yellow-300/80 rounded-full relative z-10" />
    
    {/* Soft glow behind */}
    <div className="absolute top-0 w-full h-px rounded-full blur-sm bg-linear-to-r from-yellow-300/40
     via-yellow-400/20 to-yellow-300/40 animate-pulse" />
  </div>
);
  ...
  return (
    ...
    <section id="storyy">
      ...
      <section   className="flex flex-col lg:flex-row items-center justify-center mt-[-60px] px-6 lg:px-20 gap-10 relative z-10">
        ...
        {/* STORY CARD */}
        <div className="max-w-3xl bg-white/5 bg-linear-to-b from-white/10 to-white/2 p-10 rounded-3xl backdrop-blur-2xl shadow-[0_0_60px_rgba(255,255,255,0.15)] border border-white/20 text-gray-200 text-[17px] leading-relaxed flex flex-col items-center text-center">
