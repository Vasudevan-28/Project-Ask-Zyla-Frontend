...
export default function Chatbot({scrollerRef, messages, loading, ttsSupported, speakingId, handleSpeak, input, setInput, handleSubmit, speechSupported, isListening, toggleListening, idToken}) {
  ...
  const isLight = theme === "light";
    ...
    return (
         <div className="flex-1 flex flex-col p-1 custom-scrollbar min-h-[600px] ">
            ...
            <div className={`flex-1 flex flex-col  justify-between rounded-2xl  backdrop-blur-md border border-white/20 shadow-2xl overflow-hidden relative
              ...
              <div className="p-2  bg-transparent  relative z-10">
                <form onSubmit={handleSubmit} className="flex gap-2">
                      ...
                      <button
                        ...
                        className={`absolute cursor-pointer right-3 top-1/2 transform -translate-y-1/2 p-2 rounded-lg transition-all duration-300 z-20 ${
                           isListening
                            ...
                            : `
                            ${isLight ? "bg-[#B9A3C7] text-white hover:bg-white/30 hover:text-[#B9A3C7]" : "bg-white/10 text-slate-100 hover:bg-slate-100 hover:text-slate-700"}
                  ...
                  >
                    <div className="absolute inset-0 bg-linear-to-r from-[#ab4da8] to-[#CA88B1] rounded-xl"></div>
