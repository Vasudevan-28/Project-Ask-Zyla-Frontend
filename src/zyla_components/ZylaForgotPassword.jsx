...
import TalkGood from "../gifs/shakkkyy.gif";

export default function ZylaForgotPassword() {
  ...
  const statements = [
    "Tell me your email and I’ll send a fresh OTP.",
    "I’ll send a OTP right away Check your inbox and spam folder too just in case."
  ];
  ...
  return (
   ...
   <div className="w-120 h-100 bg-transparent rounded-lg">
     <div className="relative h-full w-full">
       <div className="h-29 w-30 absolute bottom-7 right-16 left-14 bg-black rounded-full"></div>
